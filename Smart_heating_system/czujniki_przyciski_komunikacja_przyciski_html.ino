...
Servo servoX;
const int servoXtop = 180;
const int servoXbottom = 0;
int servoXcurr=0;
Servo servoY;
const int servoYtop = 130;
const int servoYbottom = 40;
int servoYcurr=0;
...
void loop() {
        ...
        int topRight = 2.5*analogRead(topRightPin);
        int botRight = 2.5*analogRead(bottomRightPin);
       ...
       if(timeDiff>=30000UL){
        ...
        for(int i=0; i<m; i=i+1)
        {
         ...
         client.print(String(round(temperature[0])));
